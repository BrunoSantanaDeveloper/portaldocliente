...
class ReceivementWinthorController extends Controller
{
    ...
    public function getReceivement($page)
    {
        ...
        $url = config('winthor.winthor_url').'api/Uteis/rotina?rotina=100001&filtros=where codcli = '.$client_id.' order by data_faturamento desc &paginado=true&pagina='.$page.'&pagesize=20';
    ...
    public function filterReceivement(Request $request)
    {
        ...
        $url = config('winthor.winthor_url').'api/Uteis/rotina?rotina=100001&filtros=where codcli = '.$client_id.$filter .'  order by data_faturamento desc &paginado=true&pagina=1&pagesize=20';
